    ...
    <x-table-body>
        @foreach($montageprijzen as $montageprijs)
            <x-table-body-row :link="route('montageprijzen.edit', $montageprijs)">
                ...
                <x-table-body-column>
                    {!! $montageprijs->old == 1 ? '<span class="text-green-500">Ja</span>' : '<span class="text-red-500">Nee</span>' !!}
                </x-table-body-column>
                <x-table-body-column>
                    {!! $montageprijs->default == 1 ? '<span class="text-green-500">Ja</span>' : '<span class="text-red-500">Nee</span>' !!}
                </x-table-body-column>
                <x-table-body-column>
